...
#[wasm_bindgen]
impl Fingering {
    #[wasm_bindgen(js_name = fromBitFlags)]
    ...
    pub fn pitch(&self) -> Option<Pitch> {
        match self.flags {
            ...
            // C#5
            n if n == LeftPointerHalf | LeftMiddle | LeftRing | RightPointer | RightMiddle | RightRing | RightLittleCsharp =>
            ...
            n if n == RightPointer as i32 =>
                Some(Pitch::new(5, PitchName::C, Accidental::Sharp)),
            n if n == LeftPointerHalf | LeftMiddle | LeftRing | LeftLittleEflat | RightPointer | RightMiddle | RightRing | RightLittleCsharp =>
                Some(Pitch::new(5, PitchName::C, Accidental::Sharp)),
            // D5
            n if n == LeftPointerHalf | LeftMiddle | LeftRing | RightPointer | RightMiddle | RightRing =>
                Some(Pitch::new(5, PitchName::D, Accidental::Natural)),
            //// D5 trill
            n if n == LeftPointer | RightPointer | RightMiddleTr3 =>
                Some(Pitch::new(5, PitchName::D, Accidental::Natural)),
            // Eb5
            n if n == LeftPointerHalf | LeftMiddle | LeftRing | RightPointer | RightMiddle | RightRing | RightLittleEflat =>
                Some(Pitch::new(5, PitchName::E, Accidental::Flat)),
            n if n == LeftPointerHalf | LeftMiddle | LeftRing | LeftLittleEflat | RightPointer | RightMiddle | RightRing =>
                Some(Pitch::new(5, PitchName::E, Accidental::Flat)),
            // E5
            ...
            n if n == LeftPointer82 | RightPointer =>
                Some(Pitch::new(6, PitchName::C, Accidental::Sharp)),
            // D6
            n if n == LeftPointerHalf | LeftMiddle | LeftRing | RightLittleC =>
                Some(Pitch::new(6, PitchName::D, Accidental::Natural)),
            n if n == LeftPointerHalf | LeftMiddle | LeftRing | RightRing | RightLittleC =>
                Some(Pitch::new(6, PitchName::D, Accidental::Natural)),
            //// D6 trill
            ...
            n if n == LeftPointer82 | LeftPointer | RightRing | RightMiddleTr3 =>
                Some(Pitch::new(6, PitchName::D, Accidental::Natural)),
            // Eb6
            n if n == LeftPointerHalf | LeftMiddle | LeftRing | LeftLittleB | RightMiddle | RightRing =>
                Some(Pitch::new(6, PitchName::E, Accidental::Flat)),
            n if n == LeftThumb83 | LeftPointerHalf | LeftMiddle | LeftRing | RightMiddle | RightRing =>
                Some(Pitch::new(6, PitchName::E, Accidental::Flat)),
            // E6
            n if n == LeftThumb83 | LeftPointerHalf | LeftMiddle | LeftRing | LeftLittleGsharp | RightMiddle | RightRing | RightLittleEflat =>
                Some(Pitch::new(6, PitchName::E, Accidental::Natural)),
            n if n == LeftThumb83 | LeftPointerHalf | LeftMiddle | LeftRing | RightPointerGsharp | RightMiddle | RightRing | RightLittleEflat =>
                Some(Pitch::new(6, PitchName::E, Accidental::Natural)),
            n if n == LeftThumb83 | LeftPointerHalf | LeftMiddle | LeftRing | LeftLittleGsharp | LeftLittleEflat | RightMiddle | RightRing =>
                Some(Pitch::new(6, PitchName::E, Accidental::Natural)),
            // F6
            n if n == LeftThumb83 | LeftPointerHalf | LeftMiddle | LeftLittleGsharp | RightMiddle | RightRing | RightLittleEflat =>
                Some(Pitch::new(6, PitchName::F, Accidental::Natural)),
            n if n == LeftThumb83 | LeftPointerHalf | LeftMiddle | RightPointerGsharp | RightMiddle | RightRing | RightLittleEflat =>
                Some(Pitch::new(6, PitchName::F, Accidental::Natural)),
            n if n == LeftThumb83 | LeftPointerHalf | LeftMiddle | LeftLittleGsharp | LeftLittleEflat | RightMiddle | RightRing =>
                Some(Pitch::new(6, PitchName::F, Accidental::Natural)),
            // F#6
